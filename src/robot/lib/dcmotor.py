...
class TB6612FNG(_DCMotorBase):
    """3-pin driver: separate direction pins + PWM enable (e.g. TB6612FNG)."""
...
class MX1508(_DCMotorBase):
    """2-pin driver: direction encoded by which pin carries PWM duty."""
...
class DCMotor:
    """Factory: returns TB6612FNG (3-pin) or MX1508 (2-pin) based on arguments.
